...
// Supabase'den gelen ham veri snake_case kullanır
    ...
    <View style={styles.card}>
      ...
      <View style={styles.cardMetrics}>
        ...
        <View style={styles.metric}>
          ...
          <Text
            style={[styles.metricText, { color: "#00D26A", fontWeight: "600" }]}
          >
...
export default function SessionsScreen() {
  ...
  const totalSpent = sessions?.reduce((sum, s) => sum + s.costTl, 0) ?? 0;
